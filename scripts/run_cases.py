...
def main(*args):
    ...
    for case_dict in case_setup:
        ...
        plot_pressure(model, L, D, mu, rho, u_in, v_i, simulation_name)
        plot_velocity_profile(model, pde, mu, u_in, v_i, D, L, simulation_name)
